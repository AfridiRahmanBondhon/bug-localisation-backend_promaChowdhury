...
def path_to_classname(file_path):
    ...
    class_name = class_name.replace(
        ".Users.promachowdhury.Desktop.fast-projects.bug-localisation-backend.bug.project.src.test.java.",
        "",
    )
...
def run_jacoco(test_class, test_method):
    p = subprocess.Popen(
        [
            f"mvn clean verify -f /Users/promachowdhury/Desktop/fast-projects/bug-localisation-backend/bug/project/pom.xml -Dtest={test_class}#{test_method} -Dmaven.test.failure.ignore=true -Drat.numUnapprovedLicenses=100"
        ],
        shell=True,
    ...
    shutil.copy(
        "/Users/promachowdhury/Desktop/fast-projects/bug-localisation-backend/bug/project/target/site/jacoco/jacoco.xml",
        f"/Users/promachowdhury/Desktop/fast-projects/bug-localisation-backend/bug/project/target/site/jacoco/{test_class}-{test_method}.xml",
    )
...
def getBuggy(tests):
    ...
    for test in tests_to_run:
        ...
        file_path = f'/Users/promachowdhury/Desktop/fast-projects/bug-localisation-backend/bug/project/target/surefire-reports/{test["class"]}.txt'
        file_path_cdata = f'/Users/promachowdhury/Desktop/fast-projects/bug-localisation-backend/bug/project/target/surefire-reports/TEST-{test["class"]}.xml'
        class_name = test["class"].replace(".", "/")
        class_path = f"/Users/promachowdhury/Desktop/fast-projects/bug-localisation-backend/bug/project/src/test/java/{class_name}.java"
        runs, failures = parse_test_results_from_file(file_path)

        method_coverage_dict = parse_xml(
            xml_file=f'/Users/promachowdhury/Desktop/fast-projects/bug-localisation-backend/bug/project/target/site/jacoco/{test["class"]}-{test["method"]}.xml',
